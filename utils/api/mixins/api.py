...
class APIMixin(object):
    ...
    def check_permissions(self, request):
        return all([p(request) for p in self.get_permission_classes()])
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        try:
            ...
            result = super(APIMixin, self).dispatch(
                request, parameters=self.get_parameters(request), *args, **kwargs)
